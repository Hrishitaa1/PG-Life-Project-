...
$user_id = isset($_SESSION['user id']) ? $_SESSION ['user_id'] : NULL;
$city_name = $_GET[" city"];

$sql_1 = "SELECT * FROM cities WHERE name ='$city_name'";
$result_1 = mysqli_query ($conn, $sq1_1);
if (!$result_1) {
...
$sql_2 = "SELECT * FROM propeties WHERE city_id ='$city_id'";
$result_2 = mysqli_query ($conn, $sq1_2);
if (!$result_2) {
    echo "Something went wrong!";
    return;
}
...
$sql_3 = "SELECT *
            ...
            INNER J0IN properties p ON iup.property_id = p.id
    ...
    <div class="page-container">
        ...
        <div class="property-card row">
            ...
            <div class="content-container col-md-8">
                <div class="row no-gutters justify-content-between">
                    <?php
                    $total_rating = ($property['rating_clear'] + $property['rating']);
